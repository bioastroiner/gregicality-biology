...
public class GCYBMetaItems {
    ...
    // PR
    public static final MicrobeItem.MicrobeOreValueItem pr_diatom = metaMicrobe1.addOreDictItem(200, "diatom", 0x82CD47, MicrobeItem.SMOOTH_CELL, MicrobeItem.PLASTID); // phytoPlanktons
    public static final MicrobeItem.MicrobeOreValueItem pr_chlorophyte = metaMicrobe1.addOreDictItem(201, "chlorophyte", 0x82CD47, MicrobeItem.SPIKY_CELL, MicrobeItem.PLASTID); // green algee
    public static final MicrobeItem.MicrobeOreValueItem pr_euglena = metaMicrobe1.addOreDictItem(202, "euglena", 0x82CD47, MicrobeItem.SPIKY_CELL, MicrobeItem.PLASTID);
